	...
	<div id="wrapper">
		...
		<? elseif ($page == 'graphics'): ?>
			<div id="metro" class="desc">
				...
				<p>Plan du métro parisien revisité pour le <a href="http://www.checkmymap.fr">concours</a> initié par <a href="http://www.checkmymetro.fr">Check my Metro</a>. Le tracé est quasiment celui du plan propriétaire de la RATP le style est une création originale.<br />Les plans sont sous licence Creative Commons BY, c'est-à-dire que vous avez le droit de les reproduire, les réutiliser et les modifier à condition de me citer comme source. Ils sont téléchargeables <a href="/metropolitain.pdf">ici, pour la version sombre</a> et <a href="/metropolitain-light.pdf">là, pour la version claire</a>.</p>
				<p class="credentials">Note&nbsp;: Si vous utilisez un autre logiciel qu'Adobe Reader pour visualiser les plans en PDF, le rendu peut-être inexact.</p>
			</div>
